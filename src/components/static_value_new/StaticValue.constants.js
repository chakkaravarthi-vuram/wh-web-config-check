...
export const STATIC_VALUE_CONSANTS = (t = translateFunction) => {
 return {
    ...
    SCANNER_PLACEHOLDER: t('flow_trigger.static_value_constants.scanner_placeholder'),
    INFORMATION: {
    ...
    LINK_TEXT_PLACEHOLDER: t('form_builder_strings.link_field.link_text_placeholder'),
    LINK_URL_PLACEHOLDER: t('form_builder_strings.link_field.link_url_placeholder'),
 };
};
