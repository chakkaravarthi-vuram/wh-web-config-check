...
export const DATALIST_ADDON_STRINGS = (t = translateFunction) => {
    return {
        IDENTIFIER: {
            ...
            UNIQUE_FIELD: {
                LABEL: t('data_lists.datalist_landing.datalist_details.language_and_others.identifier.unique_field.label'),
            },
            CUSTOM_IDENTIFER: {
