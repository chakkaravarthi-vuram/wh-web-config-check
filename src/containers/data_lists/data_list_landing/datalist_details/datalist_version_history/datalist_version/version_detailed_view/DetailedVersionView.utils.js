...
return {
  BACK_TO_DATA_AUDIT: translate('datalist.view_datalist.audit_view.detailed_audit_view_strings.back_to_data_audit'),
  EDITED: translate('datalist.view_datalist.audit_view.detailed_audit_view_strings.edited'),
  FIELDS_ON: translate('datalist.view_datalist.audit_view.detailed_audit_view_strings.fields_on'),
  ADDED: translate('datalist.view_datalist.audit_view.detailed_audit_view_strings.added'),
  DELETED: translate('datalist.view_datalist.audit_view.detailed_audit_view_strings.deleted'),
};
};
