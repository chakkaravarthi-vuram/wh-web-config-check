...
function TechnicalConfiguration(props) {
    ...
    const { TITLE, SHORT_CODE, TECHNICAL_REFERENCE_NAME } = FLOW_ADDON_STRINGS(t).TECHNICAL_CONFIGURATION;
    ...
    return (
        <div className={gClasses.MB24}>
            ...
            <Label
                ...
                innerLabelClass={cx(gClasses.FTwo13Black, gClasses.FontWeight500)}
                isLoading={isLoading}
            />
            <Text
                content={shortCode}
