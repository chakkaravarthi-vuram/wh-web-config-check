...
function ResponseBodyMapping(props) {
  ...
  useEffect(() => {
    const responseBody = getModifiedRequestBody(selectedEvent?.response_body);
    setResponseKeyOptionList(getResponseBodyMapping(responseBody));
  ...
  return (
    <div>
      <NestedDropdown
        id={id}
        placeholder={OUTPUT_FORMAT_STRINGS.KEY.PLACEHOLDER}
        searchBarPlaceholder={OUTPUT_FORMAT_STRINGS.KEY.SEARCH_PLACEHOLDER}
        optionList={
