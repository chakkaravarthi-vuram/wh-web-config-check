...
function UserIconProfileDropDown(props) {
  const { className, onClick, style, isButtonColor, role, title } = props;
...
export default UserIconProfileDropDown;
UserIconProfileDropDown.defaultProps = {
  className: null,
  onClick: null,
  style: null,
  title: null,
...
UserIconProfileDropDown.propTypes = {
