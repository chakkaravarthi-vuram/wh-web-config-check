...
function ActivateUserIcon(props) {
  const {
...
export default ActivateUserIcon;
ActivateUserIcon.defaultProps = {
  className: null,
  onClick: null,
  style: null,
  title: null,
